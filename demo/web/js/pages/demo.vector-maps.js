!function (a) {
    ...
    n.prototype.init = function () {
        a("#world-map-markers").vectorMap({
            ...
            a("#russia-vectormap").vectorMap({
                map: "russia_ru", backgroundColor: "transparent", regionStyle: {initial: {fill: "#727cf5"}}
            }),
            a("#usa-vectormap").vectorMap({
                map: "us_merc_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#727cf5"}}
            }),
            a("#india-vectormap").vectorMap({
                map: "in_mill_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#6c757d"}}
            }),
            a("#australia-vectormap").vectorMap({
                map: "au_mill_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#0acf97"}}
            }),
            a("#chicago-vectormap").vectorMap({
                map: "us-il-chicago_mill_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#39afd1"}}
            }),
            a("#uk-vectormap").vectorMap({
                map: "uk_mill_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#fa5c7c"}}
            }),
            a("#canada-vectormap").vectorMap({
                map: "ca_lcc_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#ffbc00"}}
            }),
            a("#europe-vectormap").vectorMap({
                map: "europe_mill_en", backgroundColor: "transparent", regionStyle: {initial: {fill: "#727cf5"}}
            }),
