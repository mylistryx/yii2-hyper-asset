...
colors = ["#39afd1", "#fa5c7c", "#727cf5"], (dataColors = $("#area-timeSeries").data("colors")) && (colors = dataColors.split(",")), options = {
    chart: {type: "area", stacked: !1, height: 380, zoom: {enabled: !1}}, plotOptions: {line: {curve: "smooth"}}, dataLabels: {enabled: !1}, series: [{name: "Product A", data: dataSet[0]}, {name: "Product B", data: dataSet[1]}, {name: "Product C", data: dataSet[2]}], colors: colors, markers: {size: 0, style: "full"}, stroke: {width: 3}, fill: {gradient: {enabled: !0, shadeIntensity: 1, inverseColors: !1, opacityFrom: .45, opacityTo: .05, stops: [20, 100, 100, 100]}}, yaxis: {
        labels: {
    ...
    }, title: {text: "Irregular Data in Time Series", align: "left", offsetX: 0}, tooltip: {
        shared: !0, y: {
            formatter: function (e) {
                return (e / 1e6).toFixed(0) + " points"
            }
        }
    }, legend: {position: "top", horizontalAlign: "center", offsetX: -10}, grid: {row: {colors: ["transparent", "transparent"], opacity: .2}, borderColor: "#f1f3fa"}, responsive: [{breakpoint: 600, options: {chart: {toolbar: {show: !1}}}}]
    ...
    fill: {opacity: .8, gradient: {enabled: !1}, pattern: {enabled: !0, style: ["verticalLines", "horizontalLines"], width: 5, depth: 6}},
