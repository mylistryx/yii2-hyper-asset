...
use hyper\assets\DragulaAsset;
use hyper\assets\HyperAsset;
use yii\web\View;

$this->title = 'Kanban';
$this->params['breadcrumbs'][] = $this->title;
DragulaAsset::register($this);
$this->registerJsFile('/js/ui/component.dragula.js', ['depends' => HyperAsset::class]);
?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title"><a href="#" data-bs-toggle="modal" data-bs-target="#add-new-task-modal" class="btn btn-success btn-sm ms-0">Add New</a></h4>
            </div>
        </div>
    </div>
