...
use hyper\assets\BootstrapMaxLengthAsset;
use hyper\assets\BootstrapTimePickerAsset;
use hyper\assets\BootstrapTouchSpinAsset;
use hyper\assets\CodeHighLightAsset;
use hyper\assets\DateRangePickerAsset;
use hyper\assets\FlatPickrAsset;
use hyper\assets\JqueryMaskAsset;
use hyper\assets\Select2Asset;
use hyper\assets\TypeHeadAsset;
use yii\web\View;
...
BootstrapTimePickerAsset::register($this);
BootstrapTouchSpinAsset::register($this);
BootstrapMaxLengthAsset::register($this);
JqueryMaskAsset::register($this);
TypeHeadAsset::register($this);
FlatpickrAsset::register($this);

$this->registerJsFile('/js/pages/demo.typehead.js', ['depends' => TypeHeadAsset::class]);
$this->registerJsFile('/js/pages/demo.timepicker.js', ['depends' => BootstrapTimePickerAsset::class]);
