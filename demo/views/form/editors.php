...
use hyper\assets\QuillAsset;
use hyper\assets\SimpleMdeAsset;
use yii\web\View;
...
$this->registerJsFile('/js/pages/demo.quilljs.js', ['depends' => QuillAsset::class]);
$this->registerJsFile('/js/pages/demo.simplemde.js', ['depends' => SimpleMdeAsset::class]);
