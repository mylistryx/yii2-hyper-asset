...
use hyper\assets\CalendarAsset;
use hyper\assets\HyperAsset;
use yii\web\View;

CalendarAsset::register($this);
$this->registerJsFile('/js/pages/demo.calendar.js', ['depends' => HyperAsset::class]);

$this->title = 'Calendar | Hyper - Responsive Bootstrap 5 Admin Dashboard';
