            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="border-radius-utilities-preview">
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded" alt="rounded">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded-top" alt="rounded-top">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded-end" alt="rounded-end">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded-bottom" alt="rounded-bottom">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded-start" alt="rounded-start">
                            <img src="../sources/images/users/avatar-2.jpg" class="avatar-lg rounded-circle" alt="rounded-circle">
                            <img src="../sources/images/small/small-2.jpg" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                        </div>
                    </div> <!-- end preview-->
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="border-radius-size-utilities-preview">
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-0" alt="rounded-0">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-1" alt="rounded-1">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-2" alt="rounded-2">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-3" alt="rounded-3">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-4" alt="rounded-4">
                            <img src="../sources/images/users/avatar-4.jpg" class="avatar-lg rounded-5" alt="rounded-5">
                        </div>
                    </div> <!-- end preview-->
