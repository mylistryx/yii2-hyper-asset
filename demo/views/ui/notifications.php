...
use hyper\assets\JqueryToastAsset;
use yii\web\View;

JqueryToastAsset::register($this);
CodeHighLightAsset::register($this);

$this->title = 'Notifications';
$this->params['breadcrumbs'][] = $this->title;
$this->registerJsFile('/js/pages/demo.toastr.js', ['depends' => [JqueryToastAsset::class]]);
?>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="toast fade show" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header">
                                                <img src="/images/logo-dark-sm.png"
                            ...
                            <div aria-live="polite" aria-atomic="true"
                                ...
                                <div class="toast-container position-absolute p-3" id="toastPlacement">
                                    <div class="toast show">
                                        <div class="toast-header">
                                            <img src="/images/logo-dark-sm.png" alt="brand-logo"
