                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <form>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-6">
                                                <a href="/ecommerce/shopping-cart" class="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
                                                    <i class="mdi mdi-arrow-left"></i> Back to Shopping Cart </a>
                                            </div> <!-- end col -->
                                            <div class="col-sm-6">
                                                <div class="text-sm-end">
                                                    <a href="/ecommerce/checkout" class="btn btn-danger">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="/ecommerce/products-details" class="text-body fw-semibold">Amazing Modern Chair</a>
                                                            <br>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-2.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                             height="48"/>
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="/ecommerce/products-details" class="text-body fw-semibold">Designer Awesome Chair</a>
                                                            <br>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-3.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                             height="48"/>
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="/ecommerce/products-details" class="text-body fw-semibold">Biblio Plastic Armchair</a>
                                                            <br>
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Country</label>
                                                    <select data-toggle="select2" title="Country" class="form-select">
                                                        <option value="0">Select Country</option>
                                                        <option value="AF">Afghanistan</option>
                                                        <option value="AL">Albania</option>
                                                        <option value="DZ">Algeria</option>
