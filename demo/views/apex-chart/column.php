...
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.11.0/dayjs.min.js', ['depends' => HyperAsset::class]);
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.11.0/plugin/quarterOfYear.min.js', ['depends' => HyperAsset::class]);
$this->registerJsFile('/js/pages/demo.apex-chart-column.js', ['depends' => HyperAsset::class]);
